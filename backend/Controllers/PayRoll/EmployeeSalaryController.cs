...
public class EmployeeSalaryController : ControllerBase
{
        ...
        IncreaseSalaryDto dto)
    {
        ...
        {
            return NotFound(
                "برای این کاربر هنوز حقوقی ثبت نشده است."
            );
        }

        // بررسی تاریخ تکراری
        var duplicateDate = await _context.EmployeeSalaryHistories
            .AnyAsync(x =>
                x.EmployeeSalaryId == salary.Id &&
        ...
        {
            return Conflict(
                "برای این تاریخ قبلاً یک حقوق ثبت شده است."
            );
        }

        var currentHistory = await _context.EmployeeSalaryHistories
        ...
        {
            return BadRequest(
                "رکورد فعلی حقوق در تاریخچه پیدا نشد."
            );
        }
        ...
        {
            return BadRequest(
                "تاریخ شروع حقوق جدید باید بعد از تاریخ شروع حقوق فعلی باشد."
            );
        }

        currentHistory.EffectiveTo =
